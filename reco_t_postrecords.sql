...
--
-- Table structure for table `t_postrecords`
--

DROP TABLE IF EXISTS `t_postrecords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `t_postrecords` (
  `postRecordId` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_PRS_1_idx` (`postId`),
  CONSTRAINT `FK_PRS_1` FOREIGN KEY (`postId`) REFERENCES `t_posts` (`postid`)
